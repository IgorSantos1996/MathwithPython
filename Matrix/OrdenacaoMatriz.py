...
# Organizar as linhas da Matriz A por order crescente
# dos valores da primeira coluna
# As linhas são mantidas inalteradas. Somente trocam de posição na matriz para refletir a ordenação desejada
# Esta operação faz a variável Indice receber a nova ordem da matriz
indice  = matriz_A[:, 0].argsort(axis=0)

# Esta operação faz a nova matriz receber os valores da matriz A com as linhas ordenadas
